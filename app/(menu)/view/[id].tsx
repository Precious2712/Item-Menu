...
// import { SingleData, SubDataMenu } from "@/data/item/single-product";


export default function ViewPage() {
    const { id } = useLocalSearchParams<{ id: string }>();
    const { asian, food, snacks } = useProduct();
    ...
    if (!item) return (
        <View style={styles.center}><Text>Item not found</Text></View>
    );
                ...
                <View style={styles.extrasContainer}>
                    ...
                    <FlatList
                        ...
                        renderItem={({ item: sub }) => {
                            ...
                            return (
                                <Pressable
                                    style={[styles.extraCard, selected && styles.extraCardSelected]}
                                    onPress={() => toggleExtra(sub._id)}
                                >
                                    <Image source={{ uri: sub.image }} style={styles.extraImage} />
